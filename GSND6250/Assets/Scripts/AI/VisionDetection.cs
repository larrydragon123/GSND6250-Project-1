...
public class VisionDetection : MonoBehaviour
{
    ...
    MeshCollider VisionConeCollider;
    void Start()
    {
        transform.AddComponent<MeshRenderer>().material = VisionConeMaterial;
        MeshFilter_ = transform.AddComponent<MeshFilter>();
        VisionConeMesh = new Mesh();
        VisionConeCollider = gameObject.AddComponent<MeshCollider>();
	...
	int[] triangles = new int[(VisionConeResolution - 1) * 3];
        ...
        VisionConeCollider.sharedMesh = VisionConeMesh;
        VisionConeCollider.convex = true;
